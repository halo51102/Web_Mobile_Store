...
public class BillDB {
	/*public static List<Bill> listBill(Connection conn, String username)
			throws SQLException{
	...
	public static void addBill(Connection conn, Bill bl) 
			throws SQLException{
	...
	public static Bill findBill(Connection conn, int idbill)
	throws SQLException{
	...
	public static void updateInfoBill(Connection conn, int idbill,String status, String tenkh, String sdt, String address) throws SQLException{
