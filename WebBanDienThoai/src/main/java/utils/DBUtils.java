...
public class DBUtils {
	...
	public static Login findUserForSignUp(Connection conn, String username) throws SQLException {
	...
	public static void addUser(Connection conn, Login us) throws SQLException {
